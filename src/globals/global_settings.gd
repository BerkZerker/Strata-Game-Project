...
const MAX_CHUNK_BUILDS_PER_FRAME: int = 1 # Max number of chunks to build per frame
const MAX_CHUNK_REMOVALS_PER_FRAME: int = 1 # Max number of chunks to remove per frame